...
var Version = function Version(_ref) {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      _ink.Text,
      null,
      ''.concat(_cliI18n['default'].getLocale('version_plugin_name'), ': ').concat(name),
    ),
    /*#__PURE__*/ _react['default'].createElement(
      _ink.Text,
      null,
      ''.concat(_cliI18n['default'].getLocale('version_current'), ': ').concat(version),
    ),
    /*#__PURE__*/ _react['default'].createElement(_ink.Text, null, 'Git\uFF1A', homepage),
  );
};
