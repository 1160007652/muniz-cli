...
var mergeArgv = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(ctx, next) {
    var pkgName, argv, env, pkgPath, render, newOptions, _ctx$currentModule, cliConfig, i18nLocales, result, _result2, _result2$options;

    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            pkgName = ctx.pkgName, argv = ctx.argv, env = ctx.env, pkgPath = ctx.pkgPath, render = ctx.render;
            newOptions = {};
          ...
          case 6:
            ...
            _context.t0 = argv.input.length;
            _context.next = _context.t0 === 0 ? 10 : _context.t0 === 1 ? 11 : 13;
            break;
