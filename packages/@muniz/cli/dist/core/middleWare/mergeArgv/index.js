            ...
            case 0:
              ...
              if (Object.keys(argv.options).length > 0) {
                Object.keys(argv.options).forEach(function (item) {
                  ...
                  (_astCommands$ = _astCommands[0]) === null || _astCommands$ === void 0
                    ? void 0
                    : (_astCommands$$options = _astCommands$.options) === null || _astCommands$$options === void 0
                    ? void 0
                    : _astCommands$$options.forEach(function (_options) {
                        if ([_options.alias, _options.key].includes(item)) {
                          ...
                          if (_options.type === 'boolean') {
                            ...
                            newOptions[_options.key] = isNaN(Number(optionsValue))
                              ? _options['default']
                              : Number(optionsValue);
                          } else {
                ...
                // 如果没有参数, 那么全部取预设的数据
                (_astCommands$2 = _astCommands[0]) === null || _astCommands$2 === void 0
                  ? void 0
                  : (_astCommands$2$option = _astCommands$2.options) === null || _astCommands$2$option === void 0
                  ? void 0
                  : _astCommands$2$option.forEach(function (_options) {
