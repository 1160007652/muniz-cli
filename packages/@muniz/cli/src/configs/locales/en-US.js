const enUS = {
  ...
  help_doctor_desc: 'Diagnosis of intractable scaffolding',
  doctor_title_1: 'If you use the nvm multi-version management tool, make sure to set the global path',
  doctor_title_1_info_1: 'Set environment variables:',
