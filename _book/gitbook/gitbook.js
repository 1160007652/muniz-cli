      ...
      function (e, t, n) {
        !(function (e, n) {
          ...
          function p(e) {
            return (
              'true' === e ||
              ('false' !== e && ('null' === e ? null : e === +e + '' ? +e : Ie.test(e) ? JSON.parse(e) : e))
            );
          }
          function h(e, t, n) {
            var r;
            ...
            for (var n, r, o = [], i = 0, s = e.length; i < s; i++)
              (r = e[i]),
                r.style &&
                  ((n = r.style.display),
                  t
                    ? ('none' === n && ((o[i] = Fe.get(r, 'display') || null), o[i] || (r.style.display = '')),
          ...
          function j(e, t) {
            return de.nodeName(e, 'table') && de.nodeName(11 !== t.nodeType ? t : t.firstChild, 'tr')
          ...
          function A(e, t, r, o) {
            ...
            if (
              ...
              for (a = de.map(v(i, 'script'), k), u = a.length; f < p; f++)
                (c = i), f !== h && ((c = de.clone(c, !0, !0)), u && de.merge(a, v(c, 'script'))), r.call(e[f], c, f);
              if (u)
                for (l = a[a.length - 1].ownerDocument, de.map(a, E), f = 0; f < u; f++)
                  (c = a[f]),
                    Ve.test(c.type || '') &&
                      ...
                      de.contains(l, c) &&
                      (c.src ? de._evalUrl && de._evalUrl(c.src) : n(c.textContent.replace(ot, ''), l));
            }
            return e;
          }
          function q(e, t, n) {
            for (var r, o = t ? de.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
              n || 1 !== r.nodeType || de.cleanData(v(r)),
                r.parentNode &&
                  (n && de.contains(r.ownerDocument, r) && y(v(r, 'script')), r.parentNode.removeChild(r));
            return e;
          }
          function D(e, t, n) {
            var r,
          ...
          function F(e, t, n, r, o) {
            ...
            for (i = n === (r ? 'border' : 'content') ? 4 : 'width' === t ? 1 : 0; i < 4; i += 2)
              'margin' === n && (s += de.css(e, n + We[i], !0, o)),
                r
                  ? ('content' === n && (s -= de.css(e, 'padding' + We[i], !0, o)),
                    'margin' !== n && (s -= de.css(e, 'border' + We[i] + 'Width', !0, o)))
          ...
          function B(e, t, n) {
            ...
            if (((u = !de.isEmptyObject(t)), u || !de.isEmptyObject(h))) {
              f &&
                ...
                (l = de.css(e, 'display')),
                'none' === l &&
                  (c ? (l = c) : (m([e], !0), (c = e.style.display || c), (l = de.css(e, 'display')), m([e]))),
                ...
                if (null != (e = arguments[a]))
                  for (t in e)
                    (n = s[t]),
                      (r = e[t]),
                      s !== r &&
                        (c && r && (de.isPlainObject(r) || (o = de.isArray(r)))
                          ? (o
            ...
            de.extend({
              ...
              isPlainObject: function (e) {
                ...
                return (
                  ...
                  (!(t = ne(e)) ||
                    ((n = ce.call(t, 'constructor') && t.constructor), 'function' == typeof n && le.call(n) === fe))
                );
              },
              ...
              if (!r && ((t ? t.ownerDocument || t : W) !== L && O(t), (t = t || L), F)) {
                ...
                if (T.qsa && !X[e + ' '] && (!R || !R.test(e))) {
                  if (1 !== d) (p = t), (l = e);
                    ...
                    for (
                      (a = t.getAttribute('id')) ? (a = a.replace(we, Te)) : t.setAttribute('id', (a = $)),
                        c = E(e),
                        i = c.length;
                      i--;
                ...
                if ((n = C.relative[e[a].type])) l = [d(g(l), n)];
                  ...
                  if (((n = C.filter[e[a].type].apply(null, e[a].matches)), n[$])) {
                    ...
                    return y(
                      a > 1 && g(l),
                      a > 1 &&
                        h(e.slice(0, a - 1).concat({ value: ' ' === e[a - 2].type ? '*' : '' })).replace(ae, '$1'),
                      n,
                      a < r && x(e.slice(a, r)),
                      r < o && x((e = e.slice(r))),
                      r < o && h(e),
            ...
            (T = t.support = {}),
              ...
              (C = t.selectors = {
                ...
                pseudos: {
                  ...
                  focus: function (e) {
                    return (
                      e === L.activeElement && (!L.hasFocus || L.hasFocus()) && !!(e.type || e.href || ~e.tabIndex)
                    );
                  },
                  enabled: c(!1),
                  disabled: c(!0),
              ...
              (E = t.tokenize = function (e, n) {
                ...
                for (a = e, u = [], c = C.preFilter; a; ) {
                  (r && !(o = ue.exec(a))) || (o && (a = a.slice(o[0].length) || a), u.push((i = []))),
                    (r = !1),
                    (o = ce.exec(a)) &&
                      ((r = o.shift()), i.push({ value: r, type: o[0].replace(ae, ' ') }), (a = a.slice(r.length)));
                  for (s in C.filter)
                    !(o = he[s].exec(a)) ||
                      (c[s] && !(o = c[s](o))) ||
                      ((r = o.shift()), i.push({ value: r, type: s, matches: o }), (a = a.slice(r.length)));
                  if (!r) break;
                }
              ...
              (N = t.select = function (e, t, n, r) {
                ...
                if (((n = n || []), 1 === l.length)) {
                  ...
                  for (o = he.needsContext.test(e) ? 0 : i.length; o-- && ((s = i[o]), !C.relative[(a = s.type)]); )
                    if (
                      (u = C.find[a]) &&
                      (r = u(s.matches[0].replace(xe, be), (ye.test(i[0].type) && f(t.parentNode)) || t))
                    ) {
          ...
          var ke,
            ...
            Se = (de.fn.init = function (e, t, n) {
              ...
              if (((n = n || ke), 'string' == typeof e)) {
                if (
                  ((r = '<' === e[0] && '>' === e[e.length - 1] && e.length >= 3 ? [null, e, null] : Ee.exec(e)),
                  !r || (!r[1] && t))
                )
          ...
          (de.Callbacks = function (e) {
            ...
            de.extend({
                    ...
                    then: function (t, r, o) {
                      function i(t, n, r, o) {
                        return function () {
                          ...
                          t
                            ? p()
                            : (de.Deferred.getStackHook && (p.stackTrace = de.Deferred.getStackHook()),
                              e.setTimeout(p));
                        };
                      }
                      var s = 0;
              ...
              when: function (e) {
                ...
                if (
                  t <= 1 &&
                  (c(e, i.done(s(n)).resolve, i.reject), 'pending' === i.state() || de.isFunction(o[n] && o[n].then))
                )
                  return i.then();
            ...
            de.extend({
              ...
              ready: function (e) {
                (e === !0 ? --de.readyWait : de.isReady) ||
                  ((de.isReady = !0), (e !== !0 && --de.readyWait > 0) || Oe.resolveWith(te, [de]));
              },
            }),
            (de.ready.then = Oe.then),
            'complete' === te.readyState || ('loading' !== te.readyState && !te.documentElement.doScroll)
              ? e.setTimeout(de.ready)
              : (te.addEventListener('DOMContentLoaded', l), e.addEventListener('load', l));
              ...
              data: function (e, t) {
                ...
                if (void 0 === e) {
                  if (this.length && ((o = Re.get(i)), 1 === i.nodeType && !Fe.get(i, 'hasDataAttrs'))) {
                    for (n = s.length; n--; )
                      s[n] &&
                        ((r = s[n].name), 0 === r.indexOf('data-') && ((r = de.camelCase(r.slice(5))), h(i, r, o[r])));
            ...
            de.fn.extend({
              ...
              promise: function (e, t) {
                ...
                for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; s--; )
                  (n = Fe.get(i[s], e + 'queueHooks')), n && n.empty && (r++, n.empty.add(a));
            ...
            Be = function (e, t) {
              return (
                ...
                'none' === e.style.display ||
                  ('' === e.style.display && de.contains(e.ownerDocument, e) && 'none' === de.css(e, 'display'))
              );
            },
            _e = function (e, t, n, r) {
              var o,
                  ...
                  n.handler && ((i = n), (n = i.handler), (o = i.selector)),
                    ...
                    (s = m.handle) ||
                      (s = m.handle = function (t) {
                        return 'undefined' != typeof de && de.event.triggered !== t.type
              ...
              if (m && (u = m.events)) {
                for (t = (t || '').match(qe) || [''], c = t.length; c--; )
                  if (((a = Ze.exec(t[c]) || []), (h = g = a[1]), (d = (a[2] || '').split('.').sort()), h)) {
                    ...
                    s &&
                      !p.length &&
                      ((f.teardown && f.teardown.call(e, d, m.handle) !== !1) || de.removeEvent(e, h, m.handle),
                      delete u[h]);
                  ...
                  if (1 === c.nodeType && ('click' !== e.type || c.disabled !== !0)) {
                    for (i = [], s = {}, n = 0; n < u; n++)
                      (r = t[n]),
                        (o = r.selector + ' '),
                        void 0 === s[o] &&
                          (s[o] = r.needsContext ? de(o, this).index(c) > -1 : de.find(o, this, null, [c]).length),
                        s[o] && i.push(r);
                ...
                ? (e && e.type
                    ? ((this.originalEvent = e),
                      ...
                      (this.isDefaultPrevented =
                        e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? b : w),
              ...
              function (e, t) {
                de.fn[e] = function (e) {
                  for (var n, r = [], o = de(e), i = o.length - 1, s = 0; s <= i; s++)
                    (n = s === i ? this : this.clone(!0)), de(o[s])[t](n), ie.apply(r, n.get());
            ...
            de.each(['height', 'width'], function (e, t) {
              de.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                  ...
                  return (
                    s && (o = $e.exec(n)) && 'px' !== (o[3] || 'px') && ((e.style[t] = n), (n = de.css(e, t))),
                    H(e, n, s)
                  );
                },
              };
              ...
              run: function (e) {
                ...
                return (
                  this.options.duration
                    ? (this.pos = t = de.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration))
                    : (this.pos = t = e),
          ...
          (de.Animation = de.extend(U, {
                ...
                return (
                  ...
                  this.each(function () {
                    var t,
                      ...
                      s = r ? r.length : 0;
                    for (
                      n.finish = !0, de.queue(this, e, []), o && o.stop && o.stop.call(this, !0), t = i.length;
                      t--;
            ...
            (de.fx.start = function () {
              dt ||
                (dt = e.requestAnimationFrame ? e.requestAnimationFrame(P) : e.setInterval(de.fx.tick, de.fx.interval));
            }),
            (de.fx.stop = function () {
              ...
              attr: function (e, t, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i)
                  return 'undefined' == typeof e.getAttribute
                    ? de.prop(e, t, n)
                    : ((1 === i && de.isXMLDoc(e)) ||
                        (o = de.attrHooks[t.toLowerCase()] || (de.expr.match.bool.test(t) ? vt : void 0)),
                      void 0 !== n
                        ? null === n
                  ...
                  : this.each(function () {
                      ...
                      if ('string' === n)
                        ...
                        (void 0 !== e && 'boolean' !== n) ||
                          ...
                          this.setAttribute &&
                            this.setAttribute('class', t || e === !1 ? '' : Fe.get(this, '__className__') || ''));
                    });
              },
              hasClass: function (e) {
                var t,
                ...
                if (o)
                  return (
                    ...
                    t && 'get' in t && void 0 !== (n = t.get(o, 'value'))
                      ? n
                      : ((n = o.value), 'string' == typeof n ? n.replace(wt, '') : null == n ? '' : n)
                  );
              }
            },
          }),
                ...
                select: {
                  get: function (e) {
                    ...
                    for (r = i < 0 ? u : s ? i : 0; r < u; r++)
                      if (
                        ...
                        (n.selected || r === i) &&
                          !n.disabled &&
                          (!n.parentNode.disabled || !de.nodeName(n.parentNode, 'optgroup')))
                      ) {
                  ...
                  set: function (e, t) {
                    for (var n, r, o = e.options, i = de.makeArray(t), s = o.length; s--; )
                      (r = o[s]), (r.selected = de.inArray(de.valHooks.option.get(r), i) > -1) && (n = !0);
            ...
            trigger: function (t, n, r, o) {
              ...
              if (
                ...
                if (!o && !f.noBubble && !de.isWindow(r)) {
                  for (u = f.delegateType || h, Tt.test(u + h) || (s = s.parentNode); s; s = s.parentNode)
                    p.push(s), (a = s);
                    ...
                    c
                      ? (d.ifModified &&
                        ...
                        204 === t || 'HEAD' === d.type
                          ...
                          : 304 === t
                          ? (T = 'notmodified')
                          : ((T = b.state), (p = b.data), (h = b.error), (c = !h)))
                ...
                (f = de.event && d.global),
                  ...
                  d.hasContent
                    ...
                    : ((h = d.url.slice(i.length)),
                      d.data && ((i += (kt.test(i) ? '&' : '?') + d.data), delete d.data),
                      d.cache === !1 && ((i = i.replace(Ot, '$1')), (h = (kt.test(i) ? '&' : '?') + '_=' + jt++ + h)),
                      (d.url = i + h)),
                  d.ifModified &&
                    (de.lastModified[i] && C.setRequestHeader('If-Modified-Since', de.lastModified[i]),
                  ...
                  C.setRequestHeader(
                    ...
                    d.dataTypes[0] && d.accepts[d.dataTypes[0]]
                      ? d.accepts[d.dataTypes[0]] + ('*' !== d.dataTypes[0] ? ', ' + Mt + '; q=0.01' : '')
                      : d.accepts['*'],
                  );
            ...
            de.each(['get', 'post'], function (e, t) {
              de[t] = function (e, n, r, o) {
                return (
                  ...
                  de.ajax(de.extend({ url: e, type: t, dataType: o, data: n, success: r }, de.isPlainObject(e) && e))
                );
              };
            }),
          ...
          de.ajaxSetup({
              ...
              if (a || 'jsonp' === t.dataTypes[0])
                return (
                  ...
                  a
                    ...
                    : t.jsonp !== !1 && (t.url += (kt.test(t.url) ? '&' : '?') + t.jsonp + '=' + o),
            ...
            (de.parseHTML = function (e, t, n) {
              ...
              return (
                ...
                o
                  ? [t.createElement(o[1])]
                  : ((o = x([e], t, i)), i && i.length && de(i).remove(), de.merge([], o.childNodes))
              );
            }),
                  ...
                  function (e, r, o) {
                    ...
                    return void 0 === o
                      ? i
                        ? i[t]
                        : e[r]
                      : void (i ? i.scrollTo(n ? i.pageXOffset : o, n ? o : i.pageYOffset) : (e[r] = o));
                  },
                  e,
                  r,
                  arguments.length,
          ...
          !(function (r) {
            ...
            function u(e) {
              return i(e, function (e) {
                var t = '';
                return (
                  e > 65535 && ((e -= 65536), (t += R(((e >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
                  (t += R(e))
                );
              }).join('');
            }
              ...
              for (r = i = b.length, i && b.push(A); r < m; ) {
                ...
                for (v = r + 1, c - t > F((w - n) / v) && o('overflow'), n += (c - t) * v, t = c, u = 0; u < m; ++u)
                  if (((g = e[u]), g < t && ++n > w && o('overflow'), g == t)) {
                    for (p = n, h = T; (d = h <= s ? C : h >= s + j ? j : h - s), !(p < d); h += T)
                      (x = p - d), (y = T - d), b.push(R(l(d + (x % y), 0))), (p = F(x / y));
        ...
        (r.prototype.parse = function (e, t, n) {
          ...
          if (((a = a.trim()), !n && 1 === e.split('#').length)) {
            ...
            if (f)
              return (
                ...
                f[2]
                  ? ((this.search = f[2]),
                    t ? (this.query = j.parse(this.search.substr(1))) : (this.query = this.search.substr(1)))
          ...
          (r.prototype.format = function () {
            ...
            this.host
              ? (o = e + this.host)
              : this.hostname &&
                ((o = e + (this.hostname.indexOf(':') === -1 ? this.hostname : '[' + this.hostname + ']')),
