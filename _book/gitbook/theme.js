        ...
        !(function (e, n) {
                ...
                for (c = s[s.length - 1].ownerDocument, de.map(s, E), f = 0; f < u; f++)
                  (l = s[f]),
                    Ke.test(l.type || '') &&
                      ...
                      de.contains(c, l) &&
                      (l.src ? de._evalUrl && de._evalUrl(l.src) : n(l.textContent.replace(ot, ''), c));
            }
            return e;
          }
          function q(e, t, n) {
              ...
              'margin' === n && (a += de.css(e, n + _e[i], !0, o)),
                r
                  ? ('content' === n && (a -= de.css(e, 'padding' + _e[i], !0, o)),
                    'margin' !== n && (a -= de.css(e, 'border' + _e[i] + 'Width', !0, o)))
          ...
          function W(e, t, n) {
            ...
            if (((u = !de.isEmptyObject(t)), u || !de.isEmptyObject(h))) {
              f &&
                ...
                (c = de.css(e, 'display')),
                'none' === c &&
                  (l ? (c = l) : (m([e], !0), (l = e.style.display || l), (c = de.css(e, 'display')), m([e]))),
            ...
            de.extend({
              ...
              isPlainObject: function (e) {
                ...
                return (
                  ...
                  (!(t = ne(e)) ||
                    ((n = le.call(t, 'constructor') && t.constructor), 'function' == typeof n && ce.call(n) === fe))
                );
              },
              ...
              if (!r && ((t ? t.ownerDocument || t : _) !== L && O(t), (t = t || L), F)) {
                ...
                if (C.qsa && !X[e + ' '] && (!P || !P.test(e))) {
                  if (1 !== d) (p = t), (c = e);
                    ...
                    for (
                      (s = t.getAttribute('id')) ? (s = s.replace(we, Ce)) : t.setAttribute('id', (s = $)),
                        l = E(e),
                        i = l.length;
                      i--;
                ...
                if ((n = T.relative[e[s].type])) c = [d(g(c), n)];
                  ...
                  if (((n = T.filter[e[s].type].apply(null, e[s].matches)), n[$])) {
                    ...
                    return y(
                      s > 1 && g(c),
                      s > 1 &&
                        h(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace(se, '$1'),
                      n,
                      s < r && b(e.slice(s, r)),
                      r < o && b((e = e.slice(r))),
                      r < o && h(e),
              ...
              (E = t.tokenize = function (e, n) {
                ...
                for (s = e, u = [], l = T.preFilter; s; ) {
                  (r && !(o = ue.exec(s))) || (o && (s = s.slice(o[0].length) || s), u.push((i = []))),
                    (r = !1),
                    (o = le.exec(s)) &&
                      ((r = o.shift()), i.push({ value: r, type: o[0].replace(se, ' ') }), (s = s.slice(r.length)));
                  for (a in T.filter)
                    !(o = he[a].exec(s)) ||
                      (l[a] && !(o = l[a](o))) ||
              ...
              (S = t.select = function (e, t, n, r) {
                ...
                if (((n = n || []), 1 === c.length)) {
                  ...
                  for (o = he.needsContext.test(e) ? 0 : i.length; o-- && ((a = i[o]), !T.relative[(s = a.type)]); )
                    if (
                      (u = T.find[s]) &&
                      (r = u(a.matches[0].replace(be, xe), (ye.test(i[0].type) && f(t.parentNode)) || t))
                    ) {
          ...
          (de.Callbacks = function (e) {
            ...
            de.extend({
              ...
              when: function (e) {
                ...
                if (
                  t <= 1 &&
                  (l(e, i.done(a(n)).resolve, i.reject), 'pending' === i.state() || de.isFunction(o[n] && o[n].then))
                )
                  return i.then();
              ...
              data: function (e, t) {
                ...
                if (void 0 === e) {
                  if (this.length && ((o = Pe.get(i)), 1 === i.nodeType && !Fe.get(i, 'hasDataAttrs'))) {
                    for (n = a.length; n--; )
                      a[n] &&
                        ((r = a[n].name), 0 === r.indexOf('data-') && ((r = de.camelCase(r.slice(5))), h(i, r, o[r])));
                  ...
                  if (1 === l.nodeType && ('click' !== e.type || l.disabled !== !0)) {
                    for (i = [], a = {}, n = 0; n < u; n++)
                      (r = t[n]),
                        (o = r.selector + ' '),
                        void 0 === a[o] &&
                          (a[o] = r.needsContext ? de(o, this).index(l) > -1 : de.find(o, this, null, [l]).length),
                        a[o] && i.push(r);
                ...
                ? (e && e.type
                    ? ((this.originalEvent = e),
                      ...
                      (this.isDefaultPrevented =
                        e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? x : w),
            ...
            de.each(['height', 'width'], function (e, t) {
              de.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                  ...
                  return (
                    a && (o = $e.exec(n)) && 'px' !== (o[3] || 'px') && ((e.style[t] = n), (n = de.css(e, t))),
                    H(e, n, a)
                  );
                },
              };
          ...
          (de.Animation = de.extend(U, {
            ...
            (de.fx.start = function () {
              dt ||
                (dt = e.requestAnimationFrame ? e.requestAnimationFrame(R) : e.setInterval(de.fx.tick, de.fx.interval));
            }),
            (de.fx.stop = function () {
                    ...
                    l
                      ? (d.ifModified &&
                        ...
                        204 === t || 'HEAD' === d.type
                          ...
                          : 304 === t
                          ? (C = 'notmodified')
                          : ((C = x.state), (p = x.data), (h = x.error), (l = !h)))
                ...
                (f = de.event && d.global),
                  ...
                  d.hasContent
                    ...
                    : ((h = d.url.slice(i.length)),
                      ...
                      (d.url = i + h)),
                  d.ifModified &&
                    (de.lastModified[i] && T.setRequestHeader('If-Modified-Since', de.lastModified[i]),
          ...
          de.ajaxSetup({
              ...
              if (s || 'jsonp' === t.dataTypes[0])
                return (
                  ...
                  s
                    ...
                    : t.jsonp !== !1 && (t.url += (jt.test(t.url) ? '&' : '?') + t.jsonp + '=' + o),
            ...
            (de.parseHTML = function (e, t, n) {
              ...
              return (
                ...
                o
                  ? [t.createElement(o[1])]
                  : ((o = b([e], t, i)), i && i.length && de(i).remove(), de.merge([], o.childNodes))
              );
            }),
      ...
      function (e, t, n) {
        ...
        (r.prototype.parse = function (e, t, n) {
          ...
          if (((s = s.trim()), !n && 1 === e.split('#').length)) {
            ...
            if (f)
              return (
                ...
                f[2]
                  ? ((this.search = f[2]),
                    t ? (this.query = k.parse(this.search.substr(1))) : (this.query = this.search.substr(1)))
          ...
          (r.prototype.resolveObject = function (e) {
            ...
            for (
              var E = w.slice(-1)[0],
                N = ((n.host || e.host || w.length > 1) && ('.' === E || '..' === E)) || '' === E,
                S = 0,
                A = w.length;
              A >= 0;
              A--
